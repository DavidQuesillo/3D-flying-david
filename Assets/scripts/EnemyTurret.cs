...
public class EnemyTurret : MonoBehaviour
{
    ...
    void FireAtPlayer()
    {
            ...
            GameObject shot = Instantiate(bullet, cannon.position, Quaternion.identity, null);
            shot.GetComponent<Rigidbody>().AddForce((player.position - transform.position) * bulletSpeed, ForceMode.Impulse);
